...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/html/css/estiloArticulos.css">
        <!--<script src="${pageContext.request.contextPath}/html/js/articulos.js" type="text/javascript"></script>-->
        <script src="${pageContext.request.contextPath}/html/js/Articulos/articulosColorTabla.js" type="text/javascript"></script>
    ...
    <script src="/Paniculas/html/js/Articulos/paginacion.js" type="text/javascript"></script>
</html>
