...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/html/css/estiloCategorias.css">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Sofia&effect=fire">
        <script src="/Paniculas/html/js/categorias.js" type="text/javascript"></script>
    </head>
    <body>
        <header>
