...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/css/estiloLogin.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <div class="container">
            <form action="VerificarCredenciales" onsubmit="return validar(this);" method="get" id="formulario-login" class="login-container">
