...
document.querySelector('.form-submit').addEventListener('click', function(event) {
    ...
    let nombreactual = document.getElementById('nombreactual').value;
    ...
    let categoriasSeleccionadas = document.querySelectorAll('input[name="categorias[]"]:checked');

    let parametros = new URLSearchParams();
    parametros.append('accion', "actualizarPerfil");
    parametros.append('email', email);
    parametros.append('password', password);
    parametros.append('nombreactual', nombreactual);
    parametros.append('nombrenuevo', nombrenuevo);
    parametros.append('rol', rol);
    parametros.append('direccion', direccion);
    parametros.append('codigo_postal', codigo_postal);
    parametros.append('telefono', telefono);

//    categoriasSeleccionadas.forEach(categoria => {
//        parametros.append('categorias[]', categoria.value);
//    });

    fetch("/Paniculas/html/Perfil/CredencialesDAO", { 
        method: 'POST', 
        body: parametros 
    })
    .then(response => {
...
// Validar el nombre
document.getElementById('nombrenuevo').addEventListener('change', function() {
