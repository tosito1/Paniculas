...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/css/estiloPerfilActualizar.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <main>
            <div class="contenedor-datos-usuario">
                ...
                <form action="ActualizarCredenciales" onsubmit="return validar(this);" method="post" class="registro-form">
                    <div class="campo">
                        <label for="nombre" class="form-label nombre-label">Usuario</label>
        ...
        <footer>
            ...
            <script src="${pageContext.request.contextPath}/js/formulario/validar.js" type="text/javascript"></script>
    </body>
</html>
