 ...
 * @author anton
 */
@WebServlet(name = "InsertarPeliculas", urlPatterns = {"/Paniculas/html/Perfil/InsertarPeliculas","/html/Perfil/InsertarPeliculas"})
@MultipartConfig
public class InsertarPeliculas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet InsertarPeliculas</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet InsertarPeliculas at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//            String imagen = request.getParameter("imagen");
            ...
            out = new FileOutputStream(new File(directorioDestino, nombre+".jpg"));
            ...
            String sqlCredenciales = "INSERT INTO Peliculas (nombre, categoria, anio, valoracion, director, sinopsis, imagen) VALUES (?, ?, ?, ?, ?, ?, ?)";
            psPelicula = conn.prepareStatement(sqlCredenciales);
            psPelicula.setString(1, nombre);
            ...
            psPelicula.setString(7, "img/" + categoria + "/" + nombre + ".jpg");
